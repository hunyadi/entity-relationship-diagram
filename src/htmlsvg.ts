...
class StyleCatalog {
    #styleToClass: Map<string, string> = new Map();
    #typeToStyle: Map<string, string> = new Map();
    ...
    #assignByString(style: string): string {
...
class SVGBuilder {
    ...
    #viewport: Rect = new Rect(0, 0, 0, 0);
    #root: SVGSVGElement;
    #defs: SVGDefsElement;
    #catalog: StyleCatalog = new StyleCatalog();
    ...
    #getPositionSize(element: ClientRectangleProvider): Rect {
    ...
    #visitSVG(svg: SVGSVGElement): SVGElement {
    ...
    #visitTable(table: HTMLTableElement): SVGElement {
    ...
    #visitTableRow(row: HTMLTableRowElement): SVGElement {
    ...
    #createSVGText(text: string, rect: Rect, source: Element): SVGTextElement {
    ...
    #visitText(node: Node, parent: Element): SVGElement {
    ...
    #visitElement(element: HTMLElement): SVGElement[] {
    ...
    #visitChildren(element: Element): SVGElement[] {
        const items: SVGElement[] = [];
    ...
    #visit(element: Element): SVGElement[] {
